...
### Ćwiczenie 1: Nadanie uprawnień globalnych

**Cel:**  
Naucz się nadawać uprawnienia globalne użytkownikom w SonarQube.

**Zadania:**
1. Przejdź do **Administration > Security > Permissions**.
2. Nadaj uprawnienie globalne, np. **Administer System** lub
   **Create Projects**, użytkownikowi albo grupie.
3. Zweryfikuj, że użytkownik/grupa ma poprawny dostęp, wykonując akcję
   wymagającą nowego uprawnienia.

---

### Ćwiczenie 2: Nadanie uprawnień projektowych

**Cel:**  
Zrozum, jak nadawać uprawnienia specyficzne dla projektu.

**Zadania:**
1. Przejdź do **Administration > Security > Permissions** dla konkretnego
   projektu.
2. Nadaj uprawnienia projektowe, np. **Administer Project** albo
   **Execute Analysis**, użytkownikowi lub grupie.
3. Zweryfikuj, że użytkownik/grupa może wykonywać dozwolone działania
   w projekcie.

---

### Ćwiczenie 3: Przegląd i audyt uprawnień

**Cel:**  
Naucz się przeglądać i audytować ustawione uprawnienia w SonarQube.

**Zadania:**
1. Przejdź do **Administration > Security > Permissions**.
2. Przejrzyj uprawnienia globalne i projektowe przypisane użytkownikom
   oraz grupom.
3. Sprawdź, czy któryś użytkownik lub grupa nie ma nadmiarowych uprawnień,
   i skoryguj je w razie potrzeby.
